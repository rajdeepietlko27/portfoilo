...
const projects = [
  ...
  },
  {
    ...
    stack: ['Next.js', 'Gemini AI', 'Stream', 'Prisma', 'PostgreSQL', 'Clerk', 'TailwindCSS'],
    ...
    <section id="projects" className="py-24 bg-slate-900">
      <div className="max-w-6xl mx-auto px-6">
        <div className="text-center mb-16">
          <span className="text-cyan-400 text-sm font-semibold tracking-widest uppercase mb-3 block">What I've Built</span>
          <h2 className="text-4xl md:text-5xl font-black text-white mb-4">Projects</h2>
          <p className="text-slate-400 text-lg max-w-xl mx-auto">Production-ready applications built with modern tech stacks</p>
        </div>
        ...
        <div className="space-y-8">
          {projects.map((p, i) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${p.color} opacity-0 group-hover:opacity-5 transition-opacity duration-500 pointer-events-none`} />
              ...
              <div className={`flex flex-col ${i % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                <div className="lg:w-2/5 relative overflow-hidden">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 ${p.accent} border ${p.border} rounded-full text-xs ${p.accentText} font-semibold backdrop-blur-sm`}>
                      <Calendar size={11} />
                      {p.date}
                    </span>
                  </div>
                ...
                <div className="lg:w-3/5 p-8 lg:p-10 flex flex-col justify-center">
                  <div className="mb-6">
                    <p className={`text-sm font-semibold ${p.accentText} mb-2`}>{p.tagline}</p>
                    <h3 className="text-3xl font-black text-white mb-4">{p.name}</h3>
